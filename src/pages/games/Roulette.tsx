...
import { playRoulette, RouletteResult, RouletteRequest } from '@workspace/api-client-react';
...
export default function Roulette() {
  ...
  const playMutation = useMutation<RouletteResult, Error, RouletteRequest>({
    mutationFn: (variables) => playRoulette(variables),
    onSuccess: (data) => {
      setResult(data);
      setIsSpinning(false);
      // Refresh user data
